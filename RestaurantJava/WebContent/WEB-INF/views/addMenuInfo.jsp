   ...
   <section class="header">
            ...
            <div class="col-lg-12">
              ...
              <form id="item-form" method="post" role="form" enctype="multipart/form-data" name="multipleUpload">
                ...
                <h2>Item Information</h2>
				  ...
				  <div class="form-group">
                    <input type="text" name="description" id="description" tabindex="2" class="form-control" placeholder="Description" value="">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="submit" name="update-user" id="update-item" class="btn btn-primary" value="Add">					
                  </div>
                    </div>
                  </div>
              </form>
	...
	$("#update-item").on('click',function(e){
			...
			if(!isValid.result){
				...
				$("#item-form").attr("action","addNewMenus.html");
				$("#item-form").submit();
			}
	});
