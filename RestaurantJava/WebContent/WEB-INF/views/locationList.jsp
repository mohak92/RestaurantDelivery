   ...
   <section class="header">
     <div class="container main-container">
	    <div class="row">
		  ...
		  <a href="addLocation.html" class="btn btn-default">Add Location</a>
		  </div>
<section class="middlearea regularuserpage">
    ...
    <tbody>
      <%
      		ArrayList array = (ArrayList)session.getAttribute("locationInDetail");
      		for(int i=0;i<array.size();i++){
      			
      			Location location = (Location)array.get(i);
      %>
      <tr>
        <td><%=location.getLocation_name() %></td>
        <td><%=location.getAddress() %></td>
      	<td><a href="editLocation.html?locId=<%=location.getId() %>">Edit</a></td>
      </tr>
      <%
      		}
      %>
